...
logger.setLevel(logging.DEBUG)  # Bump to DEBUG
...
class EdgeClient(fl.client.NumPyClient):
    def __init__(self, edge_id):
        ...
        self.model = Net()  # Updated to match client.py
    ...
    def fit(self, parameters, config):
        ...
        logger.debug(f"Starting Flower server on 0.0.0.0:8080", extra={"edge_id": self.edge_id})
